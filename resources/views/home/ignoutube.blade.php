        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="ignou-tube-content">
                    ...
                    <p class="grey-text sub-head-bg-bnr">Our extensive collection features enlightening videos from CUET BABA alumni sharing campus experiences, experts providing career guidance and preparation tips, in-depth analysis of previous year question papers, captivating campus diaries, and much more. These engaging narratives and tips could be your catalyst for success. Dive in, learn, and pave your path to academic glory with CUET BABA!
                    </p>
                </div>
            </div>
        </div>
...
<div class="container-main ignoutube-main-container-main" style="margin-top: 430px">
    <div class="row">
        <div class="col-lg-12">
            <div class="head-tube">
                <h1 class="text-center ignou-tube-head-pg">BABATube</h1>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="see-more-dv">
                <a href="https://www.youtube.com/@cuetbaba " target="_blank">
