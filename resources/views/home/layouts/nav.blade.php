...
<header>
  <div class="container-main">
    ...
    z-index: 12;">
      <a href="{{route('index')}}" class="navbar-logo"><img src="{{ asset('home/images/baba.png') }}" alt=""></a>
      <ul class="navbar-links ">
        ...
        <li class="nav-item">
          <a class="nav-link {{'blog-page' == request()->path() ? 'active-nav' : '' }}" href="{{route('blogpage')}}">BABAPEDIA</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link {{'preptube' == request()->path() ? 'active-nav' : '' }}" href="{{route('ignoutube')}}">BABATUBE </a>
          </li>

        <li class="nav-item">
          <a class="nav-link btn btn-download-bg text-light"  href="" data-toggle="modal" data-target="#loginModal-downloaad-gg">Download the App
...
<div class="sidebar">
  <div class="navbar-sidebar">
    <ul>
      <li><a href="https://learn.cuetbaba.com/">Courses</a></li>
      <li><a class="{{'blogpage' == request()->path() ? 'active' : '' }}" href="{{route('blogpage')}}">BABAPedia</a></li>
      ...
      <li><a class="{{'ignoutube' == request()->path() ? 'active' : '' }}" href="{{route('ignoutube')}}">BABATube</a></li>
      <li style="background: #3eca00;"><a class="{{'results' == request()->path() ? 'active' : '' }}" href="{{route('results')}}" style="color: #f7f7f7">Our Results</a></li>
      <li style="background: #e14330;"><a href="{{ route('impressions') }}" style="color: #f7f7f7"  >CUET BABA Impressions</a></li>
      <li style="background: #F05D23;"><a href="https://meetpro.club/prepwise " style="color: #ffffff" data-toggle="modal" data-target="#loginModal-downloaad-gg" >Download the App
...
<div style="z-index: 1200;" class="modal fade modal-home" id="loginModal-downloaad-gg" tabindex="-1" role="dialog"
