        ...
        <div style="position: relative;" class="col-lg-12">
            <div class="landing-section">
                <div class="land-row-first">
                    <h1 class="land-heading">India's No.1 <span class="span-color">UG</span>/<span class="span-color-two">PG</span> Entrance Coaching</h1>
                    <p class="grey-text">Unlock Potential with CUET BABA, Your Gateway to Premier Education!</p>
                    <h3 class="land-sub-heading">Trusted by Over 5000+ Students Across India</h3>
    ...
    <div class="container-main">
        <div class="row">
            <div class="col-lg-12 mb-4">
                <h1 class="why-choose-text text-center mb-3">Why choose CUET BABA?</h1>
            </div>
            <div class="col-lg-6">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="reg-enrolment">
                ...
                <p class="registertion-sub-head grey-text">Entrance exams like CUET UG/PG, IPMAT, JIPMAT, IIT JAM, TISSNET, and NCET are your passport to premier institutions - Central Universities, IITs, TISS, IIMs. The journey to these portals of excellence demands disciplined, dedicated, and structured preparation.
                <p>
                <p class="registertion-sub-head grey-text"> In this journey, CUET BABA becomes your intuitive partner. Our meticulously crafted courses harmonize with your aspirations, offering you not just exam-specific knowledge, but fostering an environment for holistic learning. Partner with CUET BABA, and experience a seamless transformation of your dreams into reality.</p>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="who-we-are who-we-are-main">
                ...
                <p class="who-we-are-descrptn grey-text">We are Team CUET BABA - a vibrant group of educators and mentors with a shared vision of unlocking academic excellence. With a strong foundation laid by our team of alumni from premier institutes like the IITs, IIMs, Central Universities, and TISS, we have built a haven for dedicated learners. Our strength lies in our diversity, expertise, and commitment towards fostering an environment where aspirations meet achievements. We believe in nurturing holistic learners who are ready to meet the challenges of tomorrow. At CUET BABA, we don't just prepare students for exams; we prepare them for life. Join us on this remarkable journey where we create, innovate, and inspire together, transforming dreams into reality!</p>
            </div>
        </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="about-ignou">
                <div class="pink-border"></div>
                <h1 class="why-ignou-heading mb-3 mt-3">About CUET BABA</h1>
                <p class="why-ignou-subhead grey-text">CUET BABA is a specialized platform designed exclusively for students striving for admissions into premier arts, science, commerce, and humanities courses in India's most sought-after institutions. Our approach to preparation is driven by a deep-seated philosophy we call "the art of preparedness." Our programs are designed around this concept, aiming not only to instruct but to prepare our students with a comprehensive understanding of their chosen field and the confidence to perform well in competitive examinations.
                </p>
                <p class="why-ignou-subhead grey-text">At the heart of our services is a blend of innovative technological and pedagogical practices. We leverage state-of-the-art digital tools and time-tested teaching methodologies to ensure an engaging and fruitful learning experience. Alongside, our performance analytics offer precise feedback on each student's progress, allowing us to customize our approach to match their unique learning curve....</p>
        ...
        <div class="col-lg-6">
            <div class="about-ignou dynamic-content">
                ...
                <p class="learn-more" style="color:#FF5F09;" onclick="ShowModal()">learn more <img
...
<div class="container-main">
    <div class="row align-items-start">
        <div class="col-lg-12 mt-4 mb-5">
            <div class="slider-home">
                <h2 class="form-head pb-4"> Unfold Your Success Journey with CUET BABA in Four Steps</h2>
                </h2>
            </div>
        </div>
        <div class="col-lg-6 mt-4">
            <div class="row-main-help">
                <div class="help-colmn mt-2">
                    ...
                    <p class="grey-text help-sub-head mb-0">Begin your journey at CUET BABA with a personalized session
...
<div class="container-main mt-4">
    <div class="ignoutube"
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="main-head-ignoutube ">BABATube</h2>
            </div>
            ...
            <div class="counsil-div">
                ...
                <div class="counsil-div-half-rgt">
                    ...
                    <div class="btns-consil">
                        <a href="tel:7594939296" class="talk-btn"> <img class="call-img"
                                src="/home/images/Call 1.png" alt=""> Talk to an Entrance Expert</a>
                        <a href=" https://wa.me/+917594939296" target="_blank" class="talk-btn ml-4"> <img
        ...
        <div class="col-lg-12">
            <div class="download-now" data-toggle="modal" data-target="#loginModal-downloaad-s">
                <div class="download-main-div">
                    ...
                    <p class="download-sub-head">Your journey to academic excellence starts here. Download the relevant CUET BABA app now, and unlock an elite entrance preparation experience, paving the way to admission in prestigious universities and colleges</p>
                </div>
                <img class="download-img" src="/home/images/Mobile Screen.png" alt="">
                ...
                <div class="container-main">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="about-dv-modal">
                                <p class="about-ignou-sub-head" style="text-align: justify" id="desc">
                                    CUET BABA is a specialized platform designed exclusively for students striving for admissions into premier arts, science, commerce, and humanities courses in India's most sought-after institutions. Our approach to preparation is driven by a deep-seated philosophy we call "the art of preparedness." Our programs are designed around this concept, aiming not only to instruct but to prepare our students with a comprehensive understanding of their chosen field and the confidence to perform well in competitive examinations.
                                    .</p>
                                <p class="about-ignou-sub-head" style="text-align: justify" id="desc">At the heart of our services is a blend of innovative technological and pedagogical practices. We leverage state-of-the-art digital tools and time-tested teaching methodologies to ensure an engaging and fruitful learning experience. Alongside, our performance analytics offer precise feedback on each student's progress, allowing us to customize our approach to match their unique learning curve.</p>
                                <p class="about-ignou-sub-head" style="text-align: justify" id="desc">
                                    Our wide array of features includes comprehensive recorded lectures, offering an in-depth view into each topic. These are supplemented with value-added notes that serve to enrich students' understanding of core concepts. To consolidate learning, we provide structured practice tests, offering students a platform to gauge their learning and rectify areas of weakness. Our flashcards and mind maps serve as handy tools for a quick revision, especially during the final stages of preparation. To replicate the exam scenario, we conduct mock tests that help students acclimatize to the actual examination. Furthermore, our personalized mentorship program and intensive SmartPrep sessions are designed to offer one-on-one guidance and solidify learned concepts.
                                    . </p>
                                <p class="about-ignou-sub-head" style="text-align: justify" id="desc">The driving force behind CUET BABA is an enthusiastic team of professionals, all of whom are graduates from India's premier institutions like IITs, IIMs, NLUs, Central Universities, and TISS. Their collective expertise, combined with their passion for teaching, is what makes CUET BABA an exceptional platform for entrance exam preparation.</p>
                                <p class="about-ignou-sub-head" style="text-align: justify" id="desc">As we always say at CUET BABA, 'With BABA, everything is possible!' (BABA HAI TO MUMKIN HAI!) Embrace your journey towards success with us, because we believe that with the right guidance and a dedicated spirit, every academic dream can be achieved.
                                </p>
                            </div>
                        </div>
                    </div>
