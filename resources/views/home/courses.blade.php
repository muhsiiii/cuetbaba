			...
			<div class="col-lg-12">
				<div class="join-commuinity-div">
					<div class="join-comnty-dub">
						...
						<p class="community-sub-head text-white">Welcome to the CUET BABA Community Groups, a unique platform where we combine the power of collective learning and expert guidance. Our dedicated Whatsapp groups cater to UG and PG entrance exams like CUET UG, CUET PG, IIT JAM, TISSNET, IPMAT/JIPMAT, NCET, and more.</p>
						...
						<p class="community-sub-head text-white">Don't just prepare for your exams, experience the journey with companions who share your goal. Whether you are an aspirant or a curious mind, there's a space for you in our thriving community. Dive in, start engaging, and enrich your learning journey with CUET BABA. Join the conversation today!</p>
