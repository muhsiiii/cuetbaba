        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="ignou-tube-content">
                    ...
                    <p class="grey-text sub-head-bg-bnr">Welcome to ‘Journey to Triumph - Student Experiences’, our illustrious repository of heartfelt student narratives, captured in videos, chronicling their distinctive journeys to success. Each story frames the effort, the challenges faced, the knowledge gleaned from CUET BABA, and their triumphant moments. Here, determination and accomplishment resonate deeply. As you dive into these inspirational tales, envisage your own successful trajectory. Remember, every journey is unique, and soon yours could be the next inspiring tale in our collection!
                    </p>
                </div>
            </div>
        </div>
...
<div class="container-main ignoutube-main-container-main" style="margin-top: 430px">
    <div class="row">
        <div class="col-lg-12">
            <div class="head-tube">
                <h1 class="text-center ignou-tube-head-pg">CUET BABA Impressions</h1>
