...
<div class="container-main">
	<div class="row">
		<div class="col-lg-12">
			<div class="talk-dv">
				<h1 class="text-center join-wtsp-grp ">Join CUET BABA WhatsApp Groups</h1>
				<h5 class="text-center join-wtsp-grip-sub-text">Step into CUET BABA's vibrant Whatsapp learning communities, where academic aspirations meet collaborative learning. Join us now!
                </h5>
			</div>
		</div>
	...
	@endforeach
		<div class="col-lg-12 mb-3">
			<div class="telegram-btn">
				<a href="https://t.me/cuetbaba" target="_blank" class="telegram-nav-btn"><i style="vertical-align: middle;" class="ri-telegram-fill"></i> Join Telegram</a>
			</div>
		</div>
	</div>
</div>
