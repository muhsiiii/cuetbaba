    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            <div class="main-btn-home" >
                <a href="https://learn.cuetbaba.com/ " target="_blank" class="btn ignou-primary-bg btns-home" > EXPLORE
                    OUR COURSES</a>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
        ...
        <div class="row">
            <div class="col-lg-12 mb-3">
                <div class="prepice-dv">
                    <h3 class="prepise-text mb-0 text-center">CUET BABA Coaching Programs</h3>
                </div>
            </div>
...
<div class="container-main mt-5">
    <div class="ignoutube"
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="main-head-ignoutube text-dark">CUET BABA Impressions</h2>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="download-now" data-toggle="modal" data-target="#loginModal-downloaad">
                ...
                <img class="download-img" src="{{ asset('home/images/Mobile Screen.png') }}" alt="">
